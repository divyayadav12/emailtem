...
const initialAccounts = [
  { id: 1, name: "Sarah Mitchell", email: "sarah.m@enterprise.com", role: "Manager", status: "Active", created: "Mar 14, 2024" },
  { id: 2, name: "John Patel", email: "j.patel@enterprise.com", role: "User", status: "Active", created: "Jul 8, 2024" },
  { id: 3, name: "Emily Chen", email: "emily.c@enterprise.com", role: "User", status: "Active", created: "May 12, 2024" },
  { id: 4, name: "Michael Brown", email: "m.brown@enterprise.com", role: "User", status: "Suspended", created: "Jun 22, 2024" },
      ...
      <div className="mx-auto max-w-5xl">
        <div className="mb-6 flex items-start justify-between">
          <div>
            ...
            <h1 className="mt-1 text-xl font-bold text-[#111827]">Team Accounts</h1>
            <p className="mt-1 text-sm text-[#6b7280]">View and manage your team's mailbox accounts and status.</p>
          </div>
        </div>
        ...
        <div className="mb-6 grid grid-cols-3 gap-4">
          <div className="rounded-xl border border-[#e2e6ef] bg-white p-4">
            ...
            <p className="mt-1 text-xl font-bold text-[#111827]">{accounts.length}</p>
          </div>
          <div className="rounded-xl border border-[#e2e6ef] bg-white p-4">
            <p className="text-xs font-semibold text-[#6b7280]">Active</p>
            <p className="mt-1 text-xl font-bold text-[#166534]">
              {accounts.filter((a) => a.status === "Active").length}
            </p>
          </div>
          <div className="rounded-xl border border-[#e2e6ef] bg-white p-4">
            <p className="text-xs font-semibold text-[#6b7280]">Suspended</p>
